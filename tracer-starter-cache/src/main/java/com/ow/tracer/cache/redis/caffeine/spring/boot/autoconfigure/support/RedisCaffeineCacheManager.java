...
import com.ow.tracer.cache.redis.caffeine.spring.boot.autoconfigure.CacheRedisCaffeineProperties;
...
public class RedisCaffeineCacheManager implements CacheManager {
    ...
    public RedisCaffeineCacheManager(CacheRedisCaffeineProperties cacheRedisCaffeineProperties,RedisTemplate<Object,Object> redisTemplate){
        ...
        this.dynamic = cacheRedisCaffeineProperties.isBynamic();
    ...
    public com.github.benmanes.caffeine.cache.Cache<Object,Object> caffeineCache(){
        ...
        if(cacheRedisCaffeineProperties.getCaffeine().getInitalCapacity() > 0) {
            cacheBuilder.initialCapacity(cacheRedisCaffeineProperties.getCaffeine().getInitalCapacity());
        }
