 ...
 */
public class DeviceServerAioListener implements ServerAioListener {
	private static Logger log = LoggerFactory.getLogger(DeviceServerAioListener.class);
	 ...
	 * @author tanyaowu
	 */
	public DeviceServerAioListener() {
	}
