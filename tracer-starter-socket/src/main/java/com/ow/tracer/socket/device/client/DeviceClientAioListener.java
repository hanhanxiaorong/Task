 ...
 */
public class DeviceClientAioListener implements ClientAioListener {
	private static Logger log = LoggerFactory.getLogger(DeviceClientAioListener.class);
	 ...
	 * @author tanyaowu
	 */
	public DeviceClientAioListener() {
	}
