...
//        short identifier = byteBuffer.getShort();
       ...
       byte version = byteBuffer.get();
        ...
        int neededLength = DeviceReadPacket.HEADER_LENGHT + length;
    ...
    public ByteBuffer encode(Packet packet, GroupContext groupContext, ChannelContext channelContext) {
        DeviceReadPacket deviceReadPacket = (DeviceReadPacket) packet;
        ...
        //总长度是消息头的长度+消息体的长度
        int allLen = DeviceReadPacket.HEADER_LENGHT +bodyLen;
