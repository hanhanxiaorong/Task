 ...
 * @description:
 */
public class DeviceWritePacket extends Packet {
    ...
    public DeviceWritePacket() {
        super();

    }

    public DeviceWritePacket(byte[] identifier, byte  version, String ipAddress, byte[] number, byte lenght, byte type, byte[] data) {
