...
public class DeviceTestRepHandler extends AbsDeviceBsHandler<DeviceTestReqBody> {
	...
	@Override
	public Object handler(DeviceReadPacket packet, DeviceTestReqBody bsBody, ChannelContext channelContext) throws Exception {
